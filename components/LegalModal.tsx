...
export default function LegalModal({
  ...
  return (
    ...
    >
      ...
      {/* Modal */}
      <div className="relative bg-white w-full sm:max-w-3xl sm:rounded-2xl shadow-2xl flex flex-col max-h-[92dvh] sm:max-h-[85vh]">
        {/* Header */}
        <div className="flex items-center justify-between px-6 py-4 border-b border-slate-100 shrink-0">
          <h1 className="font-extrabold tracking-tight text-[20px] text-black">
            {titles[type]}
          </h1>
          <button
            onClick={onClose}
